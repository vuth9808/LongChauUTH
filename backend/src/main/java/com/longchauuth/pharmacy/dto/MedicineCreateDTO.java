...
public class MedicineCreateDTO {
    ...
    // Constructors
    public MedicineCreateDTO() {
    }

    public MedicineCreateDTO(String code, String name, String genericName, Long categoryId,
            Long manufacturerId, String unit, BigDecimal price, BigDecimal costPrice) {
        this.code = code;
        this.name = name;
